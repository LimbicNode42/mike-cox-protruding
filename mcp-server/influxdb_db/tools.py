...
def register_influxdb_tools(mcp: FastMCP):
    ...
    async def influxdb_create_bucket(bucket_name: str, retention_period: str = "30d") -> str:
        ...
        try:
            ...
            bucket = buckets_api.create_bucket(bucket_name=bucket_name, org=org, retention_rules=[{
                "type": "expire",
    ...
    async def influxdb_delete_data(bucket: str, start_time: str, end_time: str, predicate: str = "") -> str:
        ...
        try:
            ...
            delete_api.delete(start_time, end_time, predicate, bucket=bucket, org=influxdb_manager.org)
