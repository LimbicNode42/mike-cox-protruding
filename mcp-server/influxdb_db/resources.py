...
def register_influxdb_resources(mcp: FastMCP):
    ...
    async def influxdb_server_info() -> str:
        ...
        try:
            ...
            return json.dumps({"error": f"Failed to get InfluxDB server info: {str(e)}"}, indent=2)
    ...
    async def influxdb_buckets() -> str:
        ...
        try:
            ...
            return json.dumps({"error": f"Failed to list InfluxDB buckets: {str(e)}"}, indent=2)
    ...
    async def influxdb_measurements(bucket: str) -> str:
        ...
        try:
            ...
            return json.dumps({"error": f"Failed to list InfluxDB measurements: {str(e)}"}, indent=2)
    ...
    async def influxdb_measurement_fields(bucket: str, measurement: str) -> str:
        ...
        try:
            ...
            return json.dumps({"error": f"Failed to get InfluxDB fields: {str(e)}"}, indent=2)
    ...
    async def influxdb_measurement_tags(bucket: str, measurement: str) -> str:
        ...
        try:
            ...
            return json.dumps({"error": f"Failed to get InfluxDB tags: {str(e)}"}, indent=2)
    
    @mcp.resource("influxdb://buckets/{bucket}/measurements/{measurement}/tags/{tag_key}/values")
    async def influxdb_tag_values(bucket: str, measurement: str, tag_key: str) -> str:
        ...
        try:
            ...
            return json.dumps({"error": f"Failed to get InfluxDB tag values: {str(e)}"}, indent=2)
    ...
    async def influxdb_sample_data(bucket: str, measurement: str) -> str:
        ...
        try:
            ...
            return json.dumps({"error": f"Failed to get InfluxDB sample data: {str(e)}"}, indent=2)
